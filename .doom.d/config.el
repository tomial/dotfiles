...
(setq doom-font (font-spec :family "Victor Mono" :size 20 :weight 'regular)
      doom-variable-pitch-font (font-spec :family "Victor Mono" :size 20)
      doom-unicode-font (font-spec :family "JetBrainsMono NF" :size 18))
